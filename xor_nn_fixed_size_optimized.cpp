...
// Dimension mismatch is now a compile-time error via static_assert.
...
int main() {
    ...
    // The fixed-size array optimization makes each epoch much faster, so higher epoch counts are feasible.
